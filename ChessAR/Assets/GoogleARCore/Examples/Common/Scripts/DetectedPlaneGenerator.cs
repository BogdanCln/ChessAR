...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        // List of game objects created by plane detection
        private List<GameObject> m_DetectedPlanes = new List<GameObject>();

        // If the position of the chess board was chosen
        private bool m_ShouldDrawPlanes = true; 
